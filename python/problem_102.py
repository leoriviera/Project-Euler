def problem_102():
    ...
    for array in points_array:
        # Get the coordinates for points A, B and C and O
        array_A = [array[0], array[1]]
        array_B = [array[2], array[3]]
        array_C = [array[4], array[5]]
        array_O = [0, 0]

        # Find the area of the triangle ABO
    ...
    # Find the area of the triangle BCO
        ...
        # If the area of the triangle ABC is equal to the area of triangles ABO, ACO and BCO...
        if t_area_t == (t_area_1 + t_area_2 + t_area_3):
            # Add one to the count, as the triangle covers the origin
            count += 1
