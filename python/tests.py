...
class ProblemTests(TestCase):
    ...
    def test_problem_26(self):
        ...
        self.assertEqual(problem_26(), 983)
    ...
    def test_problem_37(self):
        ...
        self.assertEqual(problem_37(), 748317)
    ...
    def test_problem_57(self):
        from problem_57 import problem_57

        self.assertEqual(problem_57(), 153)
